...
const Pensize = () => {
  ...
  const activeAccordionKey = location.pathname.includes("/belajar/pencontrol") || location.pathname.includes("/belajar/pencontrol/pensize")
    ? "3"
    : "0";
...
circle 50`}
            ...
            <Row>
                ...
                <Col xs={12} md={3} style={{ fontSize: '15px', marginBottom: isMobile ? '20px' : '0' }}>
                  ...
                  {[
                    { step: '1a', title: 'Gambar lingkaran', code: 'circle 100', description: 'Gambar lingkaran dengan jari jari 100 menggunakan perintah dibawah ini:' },
                    { step: '1b', title: 'Ubah Ketebalan Pena', code: 'pensize 10', description: 'Kemudian lanjutkan lagi dengan perintah dibawah ini untuk mengubah ketebalan pena menjadi 10:' },
                    { step: '1c', title: 'Maju', code: 'forward 100', description: 'Gerakkan lagi Bidawang maju sejauh 100 langkah:' },
                    { step: '1d', title: 'Gambar lingkaran', code: 'circle 50', description: 'Gambar lingkaran lagi dengan jari-jari 50:' },
                  ].map((step, index) => {
  ...
  {currentQuestion === 1 && (
    <Form.Group controlId="question1">
      ...
      {[
        { key: 'A', label: 'Mengganti warna garis menjadi hitam.' },
        { key: 'B', label: 'Mengubah ketebalan garis menjadi 10 piksel.' },
        { key: 'C', label: 'Membuat garis tidak terlihat.' },
        { key: 'D', label: 'Menghapus garis yang telah digambar.' },
      ].map(({ key, label }) => (
        <Button
          key={key}
...
circle 50`}</code></pre>
      ...
      {[
        { key: 'A', label: 'Dua lingkaran dengan ketebalan garis yang sama.' },
        { key: 'B', label: 'Lingkaran pertama memiliki garis lebih tebal daripada lingkaran kedua.' },
        { key: 'C', label: 'Lingkaran kedua memiliki garis lebih tebal daripada lingkaran pertama.' },
