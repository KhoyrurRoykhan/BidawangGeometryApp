      ...
      <div className="p-2">
        ...
        <div className='p-4 mt-5 content' style={{
          ...
          <div style={{paddingLeft:50, paddingRight:50, paddingBottom:50}}>
            ...
            <p>
              Kuis ini bertujuan untuk menguji pengetahuan Anda tentang materi <b>Kontrol Pena dan Warna</b>.
            </p>
            <p>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{ backgroundColor: '#f8fafc' }}>
                    <th style={{ padding: 10, textAlign: 'center', color:'black' }}>Nilai Kuis Kontrol Pena dan Warna</th>
                ...
                riwayatNilai.map((item, index) => (
                  <tr key={index} style={{ borderBottom: '1px solid #e2e8f0' }}>
                    <td style={{ padding: 10, textAlign: 'center' }}>{item.kuis_4 || 0}%</td>
                    <td style={{ padding: 10, textAlign: 'center' }}>
                      <span style={{
                        padding: '2px 8px',
                        backgroundColor: item.kuis_4 >= kkm ? '#d1fae5' : '#fee2e2',
                        color: item.kuis_4 >= kkm ? '#065f46' : '#991b1b',
                        border: `1px solid ${item.kuis_4 >= kkm ? '#34d399' : '#f87171'}`,
                        borderRadius: 5,
                        fontSize: '12px'
                      }}>
                        {item.kuis_4 >= kkm ? 'Lulus' : 'Tidak Lulus'}
                      </span>
                    </td>
                  </tr>
                ))
...
export default KuisPenColorControl
