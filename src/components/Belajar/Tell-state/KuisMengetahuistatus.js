...
const KuisMengetahuistatus = () => {
  ...
  const [kkm, setKkm] = useState({ kuis_3: 70 }); // default fallback 70
  ...
  const activeAccordionKey = location.pathname.includes("/belajar/tellstate") || location.pathname.includes("/belajar/tellstate/kuis")
    ? "2"
    : "0";
      ...
      <div className="p-2">
        ...
        <div className='p-4 mt-5 content' style={{
          ...
          <div style={{paddingLeft:50, paddingRight:50, paddingBottom:50}}>
            ...
            <ul>
              <li>Nilai kelulusan minimum: {kkm.kuis_3}</li>
            ...
            <button
              onClick={() => navigate('/belajar/tellstate/kuis3')}
              style={{
            ...
            <tbody>
              {loadingRiwayat ? (
                ...
                riwayatNilai.map((item, index) => {
                  const nilai = item.kuis_3 ?? 0;
                  const kkmValue = kkm?.kuis_3 ?? 70; // fallback default
...
export default KuisMengetahuistatus
