    ...
    <div className="pt-3" style={{ fontFamily: 'Verdana, sans-serif',
      ...
      <div className='p-4 mt-5 content' style={{
        ...
        <h2 style={{
            ...
            <p>
            Pada Bab ini, kamu telah mempelajari cara mengetahui status posisi dan arah bidawang saat ini dengan menggunakan beberapa fungsi penting. Adapun poin-poin penting yang dipelajari antara lain dapat dilihat pada Tabel dibawah ini.
            </p>
            ...
            <tr>
                <td>2</td>
                <td>xcor & ycor</td>
                <td>Perintah xcor dan ycor berfungsi untuk mengetahui posisi bidawang secara terpisah pada sumbu x dan y. Perintah ini membantu menentukan apakah turtle telah mencapai batas tertentu, atau digunakan dalam penghitungan pola geometris yang memerlukan pengawasan koordinat.</td>
            </tr>
            <tr>
                <td>3</td>
                <td>heading</td>
                <td>Perintah heading berguna untuk memantau arah gerakan bidawang dengan lebih tepat. Pemahaman tentang sistem derajat akan membantu siswa menggambar bentuk dan pola secara lebih akurat. </td>
            </tr>
            <tr>
                <td>4</td>
                <td>distance</td>
                <td>Perintah distance digunakan untuk menghitung jarak Euclidean antara posisi turtle saat ini dan titik tertentu dengan koordinat yang diberikan.</td>
            </tr>
...
export default RangkumanTellState
