...
print distance 100 100`}
            ...
            <Row>
                ...
                <Col xs={12} md={3} style={{ fontSize: '15px', marginBottom: isMobile ? '20px' : '0' }}>
                  ...
                  {[
                    { step: '1a', title: 'Periksa Jarak', code: 'print distance 100 0', description: 'Periksa jarak bidawang ke posisi (100,0):' },
                    { step: '1b', title: 'Bergerak Maju', code: 'forward 100', description: 'Kemudian lanjutkan lagi pada baris baru dengan perintah dibawah ini untuk menggerakan bidawang maju 100 langkah:' },
                    { step: '1c', title: 'Periksa Jarak', code: 'print distance 100 0', description: 'Periksa lagi jarak bidawang ke posisi (100,0):' }
                  ].map((step, index) => {
