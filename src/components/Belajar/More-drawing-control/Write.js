...
const correctCommands = {
    '1a': 'write("Hallo", font=("Arial",20))',
    '1b': 'penup()',
    '1c': 'setposition(0,-50)',
    '1d': 'write("Apa Kabar?", font=("Arial",15))'
  };
...
const Write = () => {
  ...
  //kunci halaman
  const [progresBelajar, setProgresBelajar] = useState(24);
...
forward 100  `}
            ...
            <Row>
                ...
                <Col xs={12} md={3} style={{ fontSize: '15px', marginBottom: isMobile ? '20px' : '0' }}>
                  ...
                  {[
                    { step: '1a', title: 'Menulis Teks', code: 'write("Hallo", font=("Arial",20))', description: 'Tulis teks "Hallo" dengan font arial dan ukuran 20 dengan perintah dibawah ini:' },
                    { step: '1b', title: 'Angkat Pena', code: 'penup', description: 'Kemudian lanjutkan lagi dengan perintah dibawah ini untuk mengangkat atau menonaktifkan pena:' },
                    { step: '1c', title: 'Ubah Posisi', code: 'setposition 0 -50', description: 'Gerakkan bidawang maju sejauh 50 langkah:' },
                    { step: '1d', title: 'Menulis Teks', code: 'write("Apa Kabar?", font=("Arial",15))', description: 'Tulis teks "Apa Kabar?" dengan font arial dan ukuran 15:' }
                  ].map((step, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <AccordionBody>
                          ...
                          <pre>
                            <code draggable={true}>{step.code}</code>
                          </pre>
  ...
  {currentQuestion === 1 && (
    <Form.Group controlId="question1">
      ...
      {[
        { key: 'A', label: 'Mengatur posisi turtle setelah menulis teks.' },
        { key: 'B', label: 'Menentukan jenis font yang digunakan.' },
        { key: 'C', label: 'Mengatur perataan teks (kiri, tengah, atau kanan).' },
        { key: 'D', label: 'Mengatur warna teks.' },
      ].map(({ key, label }) => (
        <Button
          key={key}
  ...
  {currentQuestion === 2 && (
    <Form.Group controlId="question2">
      ...
      {[
        { key: 'A', label: 'Teks ditulis di layar dengan font Arial, ukuran 12, dan bergaya italic di posisi kiri bidawang.' },
        { key: 'B', label: 'Teks ditulis di layar dengan font Arial, ukuran 12, dan bergaya italic di posisi tengah bidawang.' },
        { key: 'C', label: 'Teks ditulis di layar dengan font Arial, ukuran 12, tetapi tidak bergaya italic.' },
        { key: 'D', label: 'Tidak ada teks yang ditulis karena font tidak valid.' },
      ].map(({ key, label }) => (
        <Button
          key={key}
