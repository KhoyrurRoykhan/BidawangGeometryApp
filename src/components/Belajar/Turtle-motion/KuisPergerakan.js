      ...
      >
        ...
        <div className='p-4 content' style={{
          ...
          <div style={{paddingLeft:50, paddingRight:50, paddingBottom:50}}>
            <h2>Aturan</h2>
            <p>
              Kuis ini bertujuan untuk menguji pemahaman Anda mengenai materi <strong>Pergerakan Bidawang</strong>.
            </p>
            <p>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{ backgroundColor: '#f8fafc' }}>
                    <th style={{ padding: 10, textAlign: 'center' }}>Nilai Kuis Pergerakan</th>
