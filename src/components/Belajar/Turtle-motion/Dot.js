...
setposition 200 200`}
            ...
            <Row>
                ...
                <Col xs={12} md={3} style={{ fontSize: '15px', marginBottom: isMobile ? '20px' : '0' }}>
                  ...
                  {[
                    { step: '1a', title: 'Gambar Titik', code: 'dot 20', description: 'Gambar titik dengan ukuran 20 pada posisi saat ini:' },
                    { step: '1b', title: 'Maju', code: 'forward 50', description: 'Kemudian lanjutkan lagi pada baris baru dengan perintah dibawah ini untuk menggerakan bidawang ke depan sejauh 50 langkah:' },
                    { step: '1c', title: 'Gambar Titik Merah', code: 'dot 50 "red"', description: 'Gambar lagi titik dengan ukuran 50 dan berwarna merah:' },
                    { step: '1d', title: 'Maju', code: 'forward 100', description: 'Gerakkan lagi bidawang maju sejauh 100 langkah:' },
                    { step: '1e', title: 'Gambar Titik Kuning', code: 'dot 100 "yellow"', description: 'Gambar lagi titik dengan ukuran 100 dan berwarna kuning:' }
                  ].map((step, index) => {
  ...
  {currentQuestion === 1 && (
    <Form.Group controlId="question1">
      ...
      {[
        { key: 'A', label: 'Menggambar lingkaran penuh.' },
        { key: 'B', label: 'Menggambar busur lingkaran.' },
        { key: 'C', label: 'Menggambar titik di posisi saat ini.' },
        { key: 'D', label: 'Menghapus titik pada kanvas.' },
      ].map(({ key, label }) => (
        <Button
          key={key}
